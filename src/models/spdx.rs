...
mod test {
    ...
    mod correct_information_is_parsed_from_example_spdx {
        ...
        mod document_creation_information {
            use crate::models::{Checksum, ExternalDocumentReference};
...
compatible system run time libraries."#
        ...
        mod package_information {
            use crate::models::{
                Checksum, ExternalPackageReference, ExternalPackageReferenceCategory,
        ...
        mod file_information {
            use crate::models::{Checksum, FileType, SPDXExpression};
        ...
        mod snippet_information {
            use crate::models::{EndPointer, Range, SPDXExpression, StartPointer};
